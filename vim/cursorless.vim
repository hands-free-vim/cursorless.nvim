...
function RegisterFunctions(talon_nvim_path)
     call remote#host#RegisterPlugin('node', a:talon_nvim_path . '/node/command-server', [
          ...
          \ ])
     call remote#host#RegisterPlugin('node', a:talon_nvim_path . 'node/cursorless-neovim', [
